        ...
        <div className=" relative mb-10">
          ...
          <div id="canvas-wrapper">
            ...
            <img
              ...
              src="/Assets/images/play4-thu-nhun.png"
              alt="Hút sữa sẵn sàng dinh dưỡng cùng Abbott Grow Gold"
            />
            <div
              id="canvas"
        ...
        <div className="w-[90%] mx-auto flex justify-between px-6 items-center">
          ...
          <div className="relative">
            <img
              ...
              alt="Hút sữa sẵn sàng dinh dưỡng cùng Abbott Grow Gold"
            />
            <p className="absolute top-[100%] left-[50%] -translate-x-1/2 text-red-color text-4xl font-black w-full text-center whitespace-nowrap ">Chụp lại</p>
          </div>
